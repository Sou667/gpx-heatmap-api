# main.py
# CycleDoc Heatmap API mit vollständiger Implementierung und Static-Serving
...
def heatmap_quick():
    ...
    try:
        ...
        for seg in segs:
            ...
            center = seg['center']; elev_diff = (seg['coordinates'][-1][2] - seg['coordinates'][0][2]) if len(seg['coordinates'][0])>2 else 0
